...
<div class="main-text">
    <p>
        ...
        requirement by filtering by Location , Price, Room type, Amenities.  We will soon expand to all the Major Cities of the
        Country. PG Finder makes it easy to explore and book your ideal PG. Find the perfect place to stay, hassle-free!
    </p>
    <div class="face-icon">
        <img src="img/Logo/png/log.png" alt="icon">
    </div>
    ...
    <div class="stands-for">
        ...
        <div class="values">
            <div class="values-card">
                ...
                <p>
                    We offer a database that contains PGs, Hostels, and Dorms all throughout the nation. 
            ...
            <div class="values-card">
                ...
                <p>
                    ...
                    Thus, each house listed maintains hospitality and safety as their traditional values. 
                </p>
            </div>
        </div>
    </div>
...
<div class="working-details">
    <div class="details-card">
        ...
        <h2>Over 10+ Happy users</h2>
    </div>
    <div class="details-card">
        <h2>Over 20+ Properties listed</h2>
        <img src="img/norm/pg.jpg" alt="property-icon">
    </div>
    <div class="details-card">
        <img src="img/norm/city.jpg" alt="city-icon">
        <h2>In more than 5+ cities</h2>
    </div>
</div>
...
<div class="testimonials">
    <div class="testi-card">
        ...
        <div class="testi-card-text">
            <h4>Shubham Ghelani: Found his PG in Mumbai</h4>
            <p>
                I love this guest house. Owner and his family are amazing and help in any way possible. It is located in
                a nice party of mira road. Rooms are imple but comfortable but it’s the service that makes it so great.
                Highly recommend
            </p>
        </div>
    </div>
    <div class="testi-card">
        ...
        <div class="testi-card-text">
            <h4> Taniksha Desale: Found his PG in Delhi</h4>
            <p>
    ...
    <div class="testi-card">
        ...
        <div class="testi-card-text">
            <h4>Kartikesh Goankar: Found his Hostel in Vasai</h4>
            <p>
                ...
                almost 3 times the advertised price we paid. I booked at 600 rupees per night which seemed too good to be true.
                ...
                mistake, she cancelled our reservation and offered for us to book again at the rate of 1000 rupees per night.
            </p>
        </div>
    </div>
    <div class="testi-card">
        ...
        <div class="testi-card-text">
            <h4>Yash Daitkar : Found his home in vasai</h4>
            <p>
    ...
    <div class="testi-card">
        ...
        <div class="testi-card-text">
            <h4>Deep Godhani : Found his thikana at Delhi</h4>
            <p>
